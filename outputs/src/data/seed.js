...
export const seedData = {
  ...
  email_logs: [],
  inventory_items: [
    { id: crypto.randomUUID(), name: 'Arroz', category: 'Alimentos', lot: 'AR-2026-01', expires_at: '2026-12-31', donor: 'Banco de Alimentos', location: 'Almacen A', unit: 'kg', stock: 50, low_stock_threshold: 20, estimated_value: 65, notes: '' },
    { id: crypto.randomUUID(), name: 'Leche', category: 'Alimentos', lot: 'LE-2026-06', expires_at: '2026-07-15', donor: 'Supermercado Solidario', location: 'Camara 1', unit: 'litros', stock: 18, low_stock_threshold: 25, estimated_value: 21.6, notes: 'Reponer esta semana.' },
    { id: crypto.randomUUID(), name: 'Gel de ducha', category: 'Higiene', lot: 'HG-2026-02', expires_at: '', donor: 'Donacion particular', location: 'Estanteria H', unit: 'unidades', stock: 40, low_stock_threshold: 15, estimated_value: 80, notes: '' }
  ],
  inventory_movements: [],
  donors: [
    { id: crypto.randomUUID(), name: 'Empresa Solidaria SL', contact_name: 'Ana Ruiz', phone: '910 222 333', email: 'ana@empresasolidaria.example', donor_type: 'Empresa', estimated_value: 450, notes: 'Colaborador mensual de alimentos.' },
    { id: crypto.randomUUID(), name: 'Iglesia Comunidad Esperanza', contact_name: 'Pastora Isabel', phone: '911 444 555', email: 'contacto@comunidadesperanza.example', donor_type: 'Iglesia', estimated_value: 180, notes: 'Campanas puntuales de higiene.' }
  ],
  donations: [
  ...
  treasury_incomes: [
    { id: crypto.randomUUID(), income_at: todayISO(), category: 'Donaciones economicas', concept: 'Donacion economica inicial', amount: 600, donor: 'Empresa Solidaria SL', payment_method: 'Transferencia', notes: 'Ingreso de ejemplo para tesoreria.', document_name: '', receipt_name: '' }
  ],
  treasury_expenses: [
    { id: crypto.randomUUID(), expense_at: todayISO(), category: 'Compra de alimentos', concept: 'Compra de alimentos frescos', amount: 180, supplier: 'Mercado local', responsible: 'Elizabeth', invoice_name: '', ticket_name: '', receipt_name: '', notes: 'Gasto de ejemplo para control de caja.' }
  ],
  treasury_loans: [
  ...
  roles: [
    ...
    { id: 'coordinator', name: 'Coordinadora', modules: ['beneficiaries', 'families', 'deliveries', 'receipts', 'inventory', 'reports'] },
