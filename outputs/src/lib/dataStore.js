...
const TABLE_ORDER = {
  ...
  beneficiary_documents: 'uploaded_at',
  ...
  treasury_incomes: 'created_at',
  treasury_expenses: 'created_at',
  treasury_loans: 'created_at',
  treasury_accounts: 'created_at',
  volunteers: 'created_at',
  volunteer_history: 'participated_at',
  audit_logs: 'happened_at',
...
async function list(table) {
  if (hasSupabaseConfig) {
    const orderColumn = TABLE_ORDER[table];
