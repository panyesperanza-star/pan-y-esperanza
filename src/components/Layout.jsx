import { Bell, Boxes, Building2, Calculator, CalendarDays, Crown, DatabaseBackup, FileText, Gift, HandHeart, Handshake, Heart, Home, Inbox, Landmark, LogOut, Mail, Menu, MessageCircle, PackageCheck, PieChart, QrCode, RotateCcw, ScanLine, ServerCog, Users, UserRoundCheck, X } from 'lucide-react';
...
const icons = { dashboard: Home, notifications: Bell, 'social-care': Inbox, 'social-resources': Landmark, 'community-moderation': MessageCircle, agenda: CalendarDays, settings: Building2, beneficiaries: HandHeart, communications: Mail, families: Users, deliveries: PackageCheck, 'smart-deliveries': ScanLine, 'credential-scanner': QrCode, receipts: FileText, inventory: Boxes, donations: Gift, donors: Heart, accounting: Calculator, volunteers: UserRoundCheck, collaborators: Handshake, reports: PieChart, users: Users, backup: DatabaseBackup, provider: ServerCog, 'platform-tools': Crown };
