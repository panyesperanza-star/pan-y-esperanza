...
const RESOURCE_HISTORY_FIELDS = {
  ...
  publish_in_public_web: 'Publicacion en web publica',
  public_web_featured: 'Destacado en web publica',
...
export function sanitizeSocialResourcePayload(payload = {}, current = {}, context = {}) {
  ...
  return {
    ...
    publish_in_public_web: cleanBoolean(payload.publish_in_public_web ?? current.publish_in_public_web, false),
    public_web_featured: cleanBoolean(payload.public_web_featured ?? current.public_web_featured, false),
