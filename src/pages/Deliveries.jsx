...
import { BeneficiaryQuickSearch, BeneficiarySearchSelect } from '../components/BeneficiaryQuickSearch';
    ...
    <form className="grid gap-4 sm:grid-cols-2" onSubmit={submit}>
      <FormField label="Beneficiario">
        <BeneficiarySearchSelect
          ...
          required
          onChange={(beneficiaryId) => update('beneficiary_id', beneficiaryId)}
        />
